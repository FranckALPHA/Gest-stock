 ...
 * @param {string} [props.variant] - Variante de l'alerte (default, destructive)
 * @param {React.ReactNode} props.children - Contenu de l'alerte
 * @returns {JSX.Element} - Composant Alert
 */
 ...
 * @returns {JSX.Element} - Composant AlertTitle
 */
 ...
 * @returns {JSX.Element} - Composant AlertDescription
 */
